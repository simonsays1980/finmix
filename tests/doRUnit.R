...
if (require("RUnit", quietly = TRUE)) {
  ...
  if (Sys.getenv("RCMDCHECK") == "FALSE") {
    ## Path to unit tests for standalone running under
    ## Makefile (not R CMD check)
    ## finmix/tests/../inst/unitTests
  ...
  ## 		sep=":"), pos=3)
  ##
  ## or simply call PKG:::MyPrivateFuncion() in tests
  ...
  ## 	- failure i.e. FALSE to unit tests or
  ## 	- errors i.e. R errors
  tmp <- getErrors(tests)
