 ...
 *          Gibbs sampling with hierarchical prior. The HIER mixin
 ...
 *          sampling with hierarchical priors. These are e.g.
 *          the additional container in the 'Output' mixin to store
 ...
 *          be prepared to store sampled hyper parameters.
