...
PostOutStudmultFix (const Rcpp::List&);
virtual ~PostOutStudmultFix ()
{
}
...
inline
PostOutStudmultFix::PostOutStudmultFix (const Rcpp::List& list) :
   M(0), r(0), s(0), K(0)
{
...
inline
void PostOutStudmultFix::store(const unsigned int& m,
...
#endif /* __FINMIX_POSTOUTSTUDMULTFIX_H__ */
