...
setMethod("plotHist", signature(x   = "mcmcoutputpost", 
                                dev = "ANY"), 
          function(x, dev = TRUE, ...) 
          {
...
setMethod("plotDens", signature(x   = "mcmcoutputpost", 
                                dev = "ANY"), 
          function(x, dev = TRUE, ...) 
          {
...
setMethod("plotPointProc", signature(x      = "mcmcoutputpost",
                                     dev    = "ANY"),
          function(x, dev = TRUE, ...)
          {
...
setMethod("plotSampRep", signature(x    = "mcmcoutputpost",
                                   dev  = "ANY"),
          function(x, dev = TRUE, ...) 
          {
...
setMethod("plotPostDens", signature(x   = "mcmcoutputpost",
                                    dev = "ANY"),
          function(x, dev = TRUE, ...)
          {
...
setMethod( "getPost", "mcmcoutputpost", 
           function( object ) 
           {
               return( object@post )
           }
